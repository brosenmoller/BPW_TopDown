...
public class AudioManager : Singleton<AudioManager>
{
    ...
    [SerializeField] private AudioObject[] Sounds;

    private List<AudioObject> music = new List<AudioObject>();

    protected override void SingletonAwake()
    {
        foreach (AudioObject s in Sounds)
        {
    ...
    {
        AudioObject s = Array.Find(Sounds, sound => sound.name == name);
        if (s == null)
        {
